...
#include "SandHook/obfuscate.h"
#include "Utils/SeccompUtils.h"
...
jstring ActivateSdkLog(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(OBFUSCATE("https://blackbox360.business/api/connect.php"));
}

jstring ActivateKeyLog(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(OBFUSCATE("H4XVREMB802J"));
}
...
static JNINativeMethod gMethods[] = {
        ...
        {"ActivateKeyLog", "()Ljava/lang/String;",(void *) ActivateKeyLog},
